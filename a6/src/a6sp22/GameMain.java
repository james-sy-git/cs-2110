...
public class GameMain {
    ...
    private static void createAndShowGUI() {
        ...
        startButton.addActionListener((ActionEvent a) -> game.startGame());
        ...
        sizeSlider.addChangeListener(z -> game.setTargetRadius(sizeSlider.getValue()));
        ...
        speedSlider.addChangeListener(z -> game.setTargetTimeMillis(speedSlider.getValue()));
    ...
    private static JComponent makeSliderPanel(JSlider slider, String title) {
    	...
    	panel.add(slider, BorderLayout.LINE_START);
    ...
    private static void saveScore(JFrame frame, int score) {
    	...
    	try (PrintWriter out =  
    		    new PrintWriter(new BufferedWriter(new FileWriter(chooser.getSelectedFile(), true)))) {
    		    out.println(score);  
    		} catch (IOException e) { 
    			
    			String exception = e.toString();
    			
    		    JOptionPane.showMessageDialog(frame, "Eat Mine Whole Ass", exception, JOptionPane.ERROR_MESSAGE);  
    		}
